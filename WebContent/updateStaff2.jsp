...
String sql="Update staff set firstName='"+first_name+"',lastName='"+last_name+"',email='"+email+"',userName = '"+username+"', pass_word ='"+password+"', phone='"+phone_number+"', dob='"+dob+"',  dtype='"+type+"' where id="+id;
