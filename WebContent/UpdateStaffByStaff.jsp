...
Class.forName("com.mysql.jdbc.Driver");
   ...
   String sql ="select * from staff where userName='"+uName+"';";
...
<form method="post" action="UpdateStaffByStaff1.jsp">
...
<br>
<br>
<input type="hidden" name="type" value="<%=resultSet.getString("dtype") %>">
<br><br>
