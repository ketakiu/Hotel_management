...
String sql="Update bookings set noOfRooms='"+noOfRooms+"',noOfGuests='"+noOfGuests+"',roomType='"+roomType+"',checkIn = '"+checkIn+"', checkOut ='"+checkOut+"', facilities='"+facilities+"' where id="+id;
